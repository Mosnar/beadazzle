...
| --- | --- | --- | --- | --- |
| MarkdownEngine | `049233f` (forked from `0.8.0`) | `Mosnar/swift-markdown-engine` | Apache License 2.0 | Provides Beadazzle's markdown editing, rendering, and host-defined automatic links. Original project by `nodes-app/swift-markdown-engine`. |
...
- `Sparkle` upstream includes external-license notices for bsdiff/bspatch, sais-lite, ed25519, and signature verification code inside its `LICENSE`.
